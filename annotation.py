...
# def resize_with_fixed_scale(img, fixed_scale=1):
#     original_height, original_width = img.shape[:2]
#     new_width = int(original_width * fixed_scale)
#     new_height = int(original_height * fixed_scale)
#     resized_img = cv2.resize(img, (new_width, new_height))
#     return resized_img, fixed_scale
...
#     img_resized, fixed_scale = resize_with_fixed_scale(img, fixed_scale=0.9)
#     img_display = img_resized.copy()

#     scale_x = original_width / img_resized.shape[1]
#     scale_y = original_height / img_resized.shape[0]

#     boxes = []

#     cv2.namedWindow("Image", cv2.WINDOW_NORMAL)
#     cv2.resizeWindow("Image", img_resized.shape[1], img_resized.shape[0])
...
#         elif key == ord('r'):  # Reset drawn boxes
#             img_display = img_resized.copy()
#             boxes = []
